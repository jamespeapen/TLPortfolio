...
[This is the type of class I can see myself teaching and it was helpful to think
about teaching others what I taught myself in a less structured way]{.aside}
...
<tbody>
  ...
  <tr>
    ...
    [<br><br><br><br>I tried to use the instructors description of the final project as the problem
    to be solved and the what they learn about Rmarkdown in class as the solution to
    that problem.]{.aside}
    </td>
    <td class="tg-0lax"></td>
  </tr>
  ...
  <tr>
    ...
    <td class="tg-0lax">15</td>
    <td class="tg-0lax">Have them open a sample and knit it, fixing any errors in pairs</td>
